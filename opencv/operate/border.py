...
replicate = cv2.copyMakeBorder(img1,10,40,40,40,cv2.BORDER_REPLICATE)
...
wrap = cv2.copyMakeBorder(img1,10,40,10,40,cv2.BORDER_WRAP)
constant= cv2.copyMakeBorder(img1,10,40,40,40,cv2.BORDER_CONSTANT,value=BLUE)
